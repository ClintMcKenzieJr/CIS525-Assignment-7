...
// TODO / FIXME : Do we need setwritelist?
...
int main(int argc, char **argv)
{
	...
	// TODO / FIXME: TEST THIS A BUNCH, since I *may or may not* have literally just copied almost the entirety of Project 6 here...
	LIST_INIT(&clilist);
